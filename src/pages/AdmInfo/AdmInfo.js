...
    const isAdminGeral = currentAdminArea === 'geral';
    
...
                                    React.createElement('small', null, `Visualização de todas as manifestações (Ações restritas ao Admin de ${currentAdminAreaName})`)
                                ]
                            ),
